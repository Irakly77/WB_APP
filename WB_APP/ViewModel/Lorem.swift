...
public class Lorem {
    private static let wordList = [
        "Смотри че генерится", "Кайфы, как тебе?", "Годзила топчик, позже напишу голосовым", "че каво"
    ]
     ...
     */
    public class func words(nbWords: Int = 1) -> [String] {
     ...
     */
    public class func words(nbWords: Int = 1, useMarkdown: Bool = false) -> String {
